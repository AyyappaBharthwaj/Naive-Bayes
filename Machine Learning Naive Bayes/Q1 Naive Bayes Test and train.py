...
salary_test = pd.read_csv("E:/Data Science 18012022/Machine Learning Naive Bayes/SalaryData_Test.csv",encoding = "ISO-8859-1")
salary_train = pd.read_csv("E:/Data Science 18012022/Machine Learning Naive Bayes/SalaryData_Train.csv",encoding = "ISO-8859-1")

# cleaning data 
import re
stop_words = []
# Load the custom built Stopwords
with open("E:/Data Science 18012022/Text Mining Sentiment Analysis/stopwords_en.txt","r") as sw:
    stop_words = sw.read()
